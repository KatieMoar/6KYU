...
//PREP : Taking in two arrays. One is a list of books, one is a list of letters. I need to books that have the first letter of the letter.
//Returns : `{$letter} : ${amount} - 


//Yep absoluitely no clue about this one. Holy. 
